    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="col-span-2 sm:col-span-1 flex flex-col justify-center text-left py-28 sm:py-4">
                <div class="text-3xl font-bold text-[#073260]">Library Services</div>
                <div class="text-4xl text-slate-600 font-extrabold mt-2"><span class="text-[#01adeb]">Books</span> and <span class="text-[#01adeb]">Learning Resources</span></div>
