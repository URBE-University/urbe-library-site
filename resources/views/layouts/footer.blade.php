 <footer class="py-12 w-full bg-[#073260] text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-4 gap-8">
            <div class="col-span-4 md:col-span-2 lg:col-span-1">
                <img src="{{ asset('urbe-logo-white.svg') }}" alt="URBE University logo" class="w-32">
                <p class="mt-4 text-sm font-light">{{ __("URBE University is an educational institution organized under the laws of the Independent Education Commission of Florida, Annual License") }} <a href="https://web02.fldoe.org/CIE/SearchSchools/SchoolSearchDetail.aspx?schoolID=5594">5594</a>.</p>
