    ...
    <div class="max-w-7xl mx-auto py-4 px-4 sm:px:6 lg:px-8">
        <div class="flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center">
                ...
                <a href="https://outlook.office365.com/owa/calendar/LibraryInstructionBooking@urbe.university/bookings/" target="_blank" class="px-3 py-2 rounded-md text-sm leading-4 font-medium hover:bg-gray-50 hover:text-gray-700">Remote Library Instruction</a>
